...
const doc = new jsPDF('p', 'mm', 'a4'); // p คือ portrait (แนวตั้ง), mm คือหน่วยมิลลิเมตร
 ...
 // Define the title and timestamp
  const title = 'สรุปจำนวนผู้ขอรับเงินช่วยเหลือผู้ประสบอุทกภัยในช่วงฤดูฝน ปี 2567 ตามมติ ครม.';
...
const startY = 18; // ตำแหน่งเริ่มต้นจากขอบบน
  ...
  doc.save("สรุปจำนวนผู้ขอรับเงินช่วยเหลือผู้ประสบอุทกภัยในช่วงฤดูฝน ปี 2567 ตามมติ ครม ");

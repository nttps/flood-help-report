      ...
      <div class="font-kanit lg:w-[980px] mx-auto bg-[#F1F1F1] relative bg-[url('~/assets/images/bg-bottom.jpg')] bg-bottom bg-no-repeat bg-cover" ref="htmlContent" >
          ...
          <header class="flex bg-primary px-5 lg:px-10 py-2 space-x-4 items-center text-white rounded-b-3xl">
              ...
              <div class="lg:pt-6 lg:w-5/6">
                  <h3 class="lg:mb-3 text-lg lg:text-2xl ">จำนวนคำร้องขอรับเงินช่วยเหลือเยียวยาประชาชนที่ได้รับผลกระทบ จากกรณีน้ำท่วมขังบริเวณที่อยู่อาศัยประจำเป็นระยะเวลานานในช่วงฤดูฝน ปี พ.ศ.2568 </h3>
          ...
          <footer>
              <div class="flex flex-wrap lg:flex-nowrap bg-primary px-5 lg:px-10 py-4 lg:space-x-8 justify-between items-center text-white rounded-t-3xl">
                  <div class="text-lg pt-4 pb-2">
                      ...
                      <div class="mb-4 text-center lg:text-left">ตรวจสอบสถานะคำร้องตนเองได้ที่ : <span class="font-semibold"><a target="_blank" href="https://flood68.disaster.go.th/HELP/CheckStatusHelpRequest/Desktop">https://flood68.disaster.go.th</a></span></div>
...
<script setup >
  ...
  const downloadPDF = () => {
      ...
      html2canvas(htmlContent.value, {
          ...
          pdf.save('จำนวนคำร้องขอรับเงินช่วยเหลือเยียวยาประชาชนที่ได้รับผลกระทบ จากกรณีน้ำท่วมขังบริเวณที่อยู่อาศัยประจำเป็นระยะเวลานานในช่วงฤดูฝน ปี พ.ศ.2568.pdf');

<template>
    <div class="font-kanit lg:w-[980px] mx-auto bg-[#F1F1F1] relative bg-[url('~/assets/images/bg-bottom.jpg')] bg-bottom bg-no-repeat bg-cover" ref="htmlContent">
        ...
        <header class="flex bg-primary px-5 lg:px-10 py-2 space-x-4 lg:space-x-8 justify-between items-center text-white rounded-b-3xl">
            <div class=" min-w-max">
                <img src="~/assets/images/logo.png" class="h-[100px] lg:h-[140px] min-w-max" alt="">
            </div>
            <div class="text-lg lg:text-2xl lg:pt-6">
                <h3 class="text-center mb-4 lg:mb-6">จำนวนคำร้องขอรับเงินช่วยเหลือผู้ประสบภัยในช่วงฤดูฝน ปี พ.ศ.2567</h3>
                <div class="flex justify-between">
                    <div class="text-center lg:text-left">ในระดับจังหวัด</div>
                    <div class="text-lg font-[300] text-center lg:text-right text-white mb-1">
                        ตามมติคณะรัฐมนตรี 17 กันยายน 2567
                    </div>
                </div>
                <div class="flex justify-end text-base lg:text-lg">
                    <div class="rounded-full ml-a bg-[#FFB800] inline-flex items-center py-1 px-4 text-[#051445]">
                        ...
                        <UIcon name="disaster-clock" class="mr-2 text-[#051445]" />
                        <div>
                            09:00 น.
                        </div>
                    </div>
        ...
        <main class="px-4 lg:px-8 mt-2" v-if="pending">
            <section class="bg-primary rounded-2xl p-3">
               <div class="flex flex-wrap lg:flex-nowrap gap-4 lg:gap-2">
                    <div class="bg-secondary py-4 rounded-xl w-full lg:w-3/5 flex flex-col justify-center items-center">
                    ...
                    <div class="bg-secondary rounded-xl w-full lg:w-2/5 flex flex-col justify-center items-center">
        ...
        <footer>
            <div class="flex flex-wrap lg:flex-nowrap bg-primary px-5 lg:px-10 py-4 lg:space-x-8 justify-between items-center text-white rounded-t-3xl">
                <div class="text-lg pt-4 pb-2">
                    ...
                    <div class="mb-4 text-center lg:text-left">ตรวจสอบสถานะคำร้องตนเองได้ที่ : <span class="font-semibold"><a target="_blank" href="https://flood67.disaster.go.th">https://flood67.disaster.go.th</a></span></div>

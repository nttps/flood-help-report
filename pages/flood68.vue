      ...
      <div class="font-kanit lg:w-[980px] mx-auto bg-[#F1F1F1] relative bg-[url('~/assets/images/bg-bottom.jpg')] bg-bottom bg-no-repeat bg-cover" ref="htmlContent" >
          ...
          <header class="flex bg-primary px-5 lg:px-10 py-2 space-x-4 items-center text-white rounded-b-3xl">
              ...
              <div class="lg:pt-6 lg:w-5/6">
                  <h3 class="lg:mb-3 text-lg lg:text-2xl ">จำนวนคำร้องขอรับเงินช่วยเหลือผู้ประสบภัยในช่วงฤดูฝน ปี พ.ศ.2568 </h3>
...
<script setup >
  ...
  const { data: report, status } = await useFetch('/api/onepage?database=DPM_HELP68_FLOOD&nocache='+ new Date().toISOString(), {
      cache: 'no-store',
      headers: {
  ...
  const downloadPDF = () => {
      ...
      html2canvas(htmlContent.value, {
          ...
          pdf.save('จำนวนคำร้องขอรับเงินช่วยเหลือผู้ประสบภัยในช่วงฤดูฝน ปี พ.ศ.2568.pdf');

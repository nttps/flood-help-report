    ...
    <div>
        ...
        <div class="font-kanit lg:w-[980px] mx-auto bg-[#F1F1F1] relative bg-[url('~/assets/images/bg-bottom.jpg')] bg-bottom bg-no-repeat bg-cover" ref="htmlContent" >
            ...
            <main class="px-4 lg:px-8 mt-2" v-if="pending">
                ...
                <div class="grid grid-cols-3 lg:grid-cols-4 gap-2 justify-center ">
                  <div class="bg-white py-4 lg:py-8 rounded-xl items-center flex flex-col justify-center text-center " v-for="d in report.allRequest.slice(3, 7)" :key="d">
  ...
  <script setup >
    ...
    const downloadPDF = () => {
        ...
        html2canvas(htmlContent.value, {
            ...
            pdf.save('จำนวนคำร้องขอรับเงินช่วยเหลืออันเนื่องมาจากการกระทำของกองกำลังจากนอกประเทศ ปี พ.ศ.2568  ตามมติคณะรัฐมนตรี 26 สิงหาคม 2568.pdf');
